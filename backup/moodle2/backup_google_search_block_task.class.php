...
require_once($CFG->dirroot.'//blocks/google_search/backup/moodle2/backup_google_search_stepslib.php');
require_once($CFG->dirroot.'//blocks/google_search/backup/moodle2/backup_google_search_settingslib.php');

/**
 * Provides all the settings and steps to perform a complete backup of block_google_search.
 */
class backup_google_search_block_task extends backup_block_task {
