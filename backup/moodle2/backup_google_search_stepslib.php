...
/**
 * Backup steps for block_google_search are defined here.
 *
 ...
 */
class backup_google_search_block_structure_step extends backup_block_structure_step {
    ...
    protected function define_structure() {
        ...
        $attributes = null;
        $finalelements = null;
        $root = new backup_nested_element('block_google_search', $attributes, $finalelements);
