...
/**
 * The task that provides a complete restore of block_google_search is defined here.
 *
...
require_once($CFG->dirroot.'//blocks/google_search/backup/moodle2/restore_google_search_stepslib.php');

/**
 * Restore task for block_google_search.
 */
class restore_google_search_block_task extends restore_block_task {
